...
await writeFile(join(dist,'build-info.json'),JSON.stringify({version:'0.4.0',target:crazy?'crazygames':'web',persistentRewards:false,signalingConfigured:Boolean(signal)},null,2)+'\n');
