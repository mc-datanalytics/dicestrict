...
const sources={};for(const p of ['src/scene/harmony/kit.js','src/scene/harmony/architecture.js','src/scene/harmony/extensions.js','src/scene/marina/mesh-builder.js','src/scene/marina/surfaces.js'])sources[p]=createHash('sha256').update(await readFile(resolve(root,p))).digest('hex');
